<?php
    ...
    Description: Create and customize your own PayPal button! Add the widget to your theme, or create a Paypal Button on ANY page or post by using the shortcode [powr-paypal-button]. Then, simply visit your site and click the settings icon to customize your Paypal Button right in the page. Many more plugins & tutorials at POWr.io.
    Author: POWr.io
    Version: 1.0
    ...
    */
    ...
    class Powr_Paypal_Button extends WP_Widget{
      //Create the widget
      ...
      public function form( $instance ){
        ?>
        <p>
          No need to edit here - just click the gears icon on your Paypal Button.
        </p>
        <p>
    ...
    function register_powr_paypal_button() {
      register_widget( 'Powr_Paypal_Button' );
    }
