...
Tags: PayPal, paypal button, payments, ecommerce, donate button, checkout button, buy now button, paypal widget, paypal plugin, purchase button
...
== Description ==
**POWr Paypal Button** is a fast, simple, and easily customized plugin you can edit **right in your web page**.
Add the widget to your site, or use the shortcode **[powr-paypal-button]** to add Paypal Button to any post.
<br><br>
...
= How can I add Paypal Button to a blog post or page? = Just add the shortcode **[powr-paypal-button label='MY LABEL']** (including the brackets) in your post where you'd like your Paypal Button to appear. Then visit your page!

= How can I add  Paypal Button to my site multiple times? = Just be sure to specify different label text, eg **[powr-paypal-button label='MY LABEL 1']**, **[powr-paypal-button label='MY LABEL 2']** for each time you use the plugin
...
= Will my users see the settings icon in the corner of the Paypal Button? = No! You only see the settings icon because you own the plugins. To temporarily hide it, click on your page and then type 'p + down arrow' (the letter p followed by the down arrow). You can show the icon again by typing 'p + up-arrow'.
...
= Is POWr Paypal Button Free? = Yes, the basic version of Paypal Button is completely free!
